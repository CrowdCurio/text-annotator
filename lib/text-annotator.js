...
$.widget('crowdcurio.TextAnnotator', {
    ...
    $(that.element).html(content);
        ...
        for(var i=0; i < nodes.length; i++){
            var content;
            var justificationForm = '';
            
            if(that.options.config.justification){
                justificationForm = '<div class="row"><form class="col s12"><div class="row"><div class="input-field col s12"><textarea id="starter-justification" class="materialize-textarea"></textarea><label for="textarea1" class="">Explain why your answer is \'Yes\' or \'No\'.</label></div> </div></form></div>';
            }
                    ...
                    <div class="row"> \
                        <div class="col s12 m6 box-container"> \
                            <div class="card"> \
                                ...
                                <div class="annotation-decision card-action">'+justificationForm+'\
                                <button id="'+nodes[i]+'-yes" class="btn next-btn waves-effect waves-light" name="action">Yes\
                                    <i class="fa fa-check" aria-hidden="true"></i>\
                                </button>\
                                <button id="'+nodes[i]+'-no" class="btn next-btn waves-effect waves-light" name="action">No\
