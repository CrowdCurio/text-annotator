                ...
                if(choice !== correct_answer){
                    ...
                    switch(cur_node){
                            ...
                            case "missing-information-node-a": 
                                if($(".missing-information-btn.teal").length < 1){
                                    swal("You must select a label before clicking next.");
                                    return;
                                }
                            ...
                            case "missing-information-node-b": 
                                ...
                                break;    
                            case "consistency-check-node-a": 
                                if($(".consistency-check-btn.teal").length < 1){
                                    swal("You must select a label before clicking next.");
                                    return;
                                }
        
                                choice = $(".consistency-check-btn.teal").val().replace('-relation', '');
